        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <a
                href="mailto:it@techflow-sloutions.site?subject=Enterprise%20Solution%20Inquiry"
            ...
            <div className="flex items-center space-x-8 pt-8">
              <div className="flex items-center">
                ...
                <div>
                  <div className="font-semibold text-lg">{t.hero.certification}</div>
                  <div className="text-sm text-gray-400">{t.hero.certificationSub}</div>
                </div>
              </div>
              <div className="flex items-center">
                <Globe className="w-8 h-8 text-blue-400 mr-3" />
                <div>
                  <div className="font-semibold text-lg">{t.hero.support}</div>
                  <div className="text-sm text-gray-400">{t.hero.supportSub}</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="relative">
            ...
            <div className="absolute -bottom-6 -right-6 bg-gradient-to-r from-blue-600 to-blue-800 text-white p-6 rounded-xl shadow-xl z-20">
              <div className="text-3xl font-bold">{t.hero.projectsCount}</div>
              <div className="text-sm opacity-90">{t.hero.projectsDelivered}</div>
            </div>
          </div>
        </div>
      </div>
